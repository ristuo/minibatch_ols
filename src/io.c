...
bool eof(io_res_ptr x) { return x->eof; }

index rows_read(io_res_ptr res) { return res->rows_read; }

index cols_read(io_res_ptr res) { return res->cols_read; }

char *path(io_res_ptr res) { return res->path; }

index bytes_read(io_res_ptr res) { return res->bytes_read; }

number **values(io_res_ptr res) { return res->values; }
...
float read_float(index *bytes_read, char separator, char *line, ssize_t llength,
                 int start) {
...
io_res_ptr read_batch_fp(FILE *fp, char separator, index nrow,
                         char *file_path) {
